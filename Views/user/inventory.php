...
<div class="w3-quarter" style="overflow-y: scroll;height:346px;overflow-x:hidden;margin-left:10px;" id="InvData">
    <div class="w3-bar w3-card w3-button m8-fancy" style="margin-bottom:10px; background-color:#2178c7" w3-repeat="result">
...
<div class="" style="display:none; float: right; width:72%;" id="txtHint">
    <div class="w3-container">
        <div id="txtResult">
            <div class="w3-card w3-white w3-margin-bottom w3-row m8-fancy" style="border: 3px solid #2178c7;height:346px;">
    ...
    <div class="w3-col s6 m3 l3" style="padding:5px;margin-left:12px;"><button class="w3-button w3-color m8-fancy" style="width:100%;" onclick="deleteSingleDevice()"><i class="fa fa-trash"></i> Delete</button></div>
</div>
