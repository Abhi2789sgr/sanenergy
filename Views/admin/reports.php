<header class="w3-container w3-text-indigo" style="padding-top:22px">
	<h5><b><i class="fa fa-file-text-o fa-fw"></i>Download Reports</b></h5>
</header>
<div class="w3-container w3-margin-bottom">
	...
	<button style="margin:5px" class="w3-right w3-button w3-color m8-fancy w3-margin-top" onclick="downloadFaultyReport()">Download Faulty Report</button>
...
function downloadFaultyReport(){
	var url = '../Controller/devicesFaultyExport.php';
		window.location.href = url;
}
</script>
